...
#[AsCommand(name: 'make-app:request')]
class RequestMakeCommand extends ConsoleRequestMakeCommand
{
     ...
     * @var string
     */
    protected $name = 'make-app:request';
     ...
     * @deprecated
     */
    protected static $defaultName = 'make-app:request';
    ...
    protected function getDefaultNamespace($rootNamespace)
    {
        ...
        return $rootNamespace.'\Src\\'.(Str::title($app)).'\\'.(Str::title($group)).'\\Requests';
    }
}
